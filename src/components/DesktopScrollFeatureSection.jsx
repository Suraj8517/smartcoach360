...
const DesktopScrollFeatureSection = () => {
  ...
  return (
    <div className="min-h-screen mt-8 pt-8">
      <div ref={sectionRef} className="relative min-h-[400vh]">
        <div className="max-w-400 mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-[320px_1fr] gap-6 lg:gap-10">
            {/* LEFT SECTION - Sticky Navigation */}
            <div>
                  ...
                  <div className="space-y-1 xl:mt-8">
                    {features.map((feature, index) => (
                      <div
                        ...
                        className={`flex items-start gap-3 px-4 py-1 xl:py-1 rounded-lg cursor-pointer transition-all duration-300 ${
            ...
            <div className="space-y-14 pb-24 mt-12 pt-12">
              {features.map((feature, index) => (
                <div
                  key={index}
                    ...
                    <div className="pt-6">
                      ...
                      <ul className="space-y-1">
                        {feature.details.map((detail, i) => (
                          <li key={i} className="font-bold text-slate-700 text-sm">
...
export default DesktopScrollFeatureSection;
